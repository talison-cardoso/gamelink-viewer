...
export const TRANSLATIONS: Record<Language, any> = {
  en: {
    ...
    legalNotice: 'This site does not host any files. It only renders public links provided by third parties.',
    legalNoticeDetailed: 'This application is only a link renderer. We do not host, store or distribute any files or links. All content is fetched dynamically from JSON sources provided by the user.',
    howItWorks: 'How it works',
    howItWorksDesc: 'Paste a JSON URL from your favorite source to render the download list instantly. Your sources are saved locally in your browser.',
    selectSource: 'SELECT A SOURCE TO START',
    close: 'Close',
    remove: 'Remove',
    refresh: 'Refresh',
    validating: 'Validating...',
    invalidSource: 'Invalid source. The URL must point to a compatible JSON file.',
  ...
  pt: {
    ...
    language: 'Idioma',
    noSources: 'Nenhuma fonte adicionada ainda. Adicione uma URL JSON para começar.',
    legalNotice: 'Este site não hospeda arquivos. Apenas renderiza links públicos fornecidos por terceiros.',
    legalNoticeDetailed: 'Este aplicativo é apenas um renderizador de links. Não hospedamos, armazenamos ou distribuímos quaisquer arquivos ou links. Todo o conteúdo é obtido dinamicamente de fontes JSON fornecidas pelo usuário.',
    howItWorks: 'Como funciona',
    howItWorksDesc: 'Cole uma URL JSON de sua fonte favorita para listar os downloads instantaneamente. Suas fontes são salvas localmente no seu navegador.',
    selectSource: 'SELECIONE UMA FONTE PARA COMEÇAR',
    close: 'Fechar',
    remove: 'Remover',
    refresh: 'Atualizar',
    validating: 'Validando...',
    invalidSource: 'Fonte inválida. A URL deve apontar para um arquivo JSON compatível.',
  ...
  es: {
    ...
    legalNotice: 'Este sitio no aloja ningún archivo. Solo renderiza enlaces públicos proporcionados por terceros.',
    legalNoticeDetailed: 'Esta aplicación es solo un renderizador de enlaces. No alojamos, almacenamos ni distribuimos ningún archivo o enlace. Todo el contenido se obtiene dinámicamente de fuentes JSON proporcionadas por el usuario.',
    howItWorks: 'Cómo funciona',
    howItWorksDesc: 'Pegue una URL JSON de su fuente favorita para listar las descargas al instante. Sus fuentes se guardan localmente en su navegador.',
    selectSource: 'SELECCIONE UNA FUENTE PARA COMENZAR',
    close: 'Cerrar',
    remove: 'Eliminar',
    refresh: 'Refrescar',
    validating: 'Validando...',
    invalidSource: 'Fuente inválida. La URL debe apuntar a un archivo JSON compatible.',
...
export const MIRROR_RULES = [
  ...
  { pattern: /buzzheavier\.com/, name: 'BuzzHeavier', color: 'badge-secondary' },
  ...
  { pattern: /krakenfiles\.com/, name: 'KrakenFiles', color: 'badge-secondary' },
